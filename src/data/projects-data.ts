...
const projects: Array<ProjectDto> = [
    ...
    { number: 4, name: 'OfflinePass', link: 'https:tikeet.io', image: 'offlinepass.jpg' },
    { number: 5, name: 'Kuber IDE', link: 'https:tikeet.io', image: 'offlinepass.jpg' }
    // { projectName: 'BBVS', link: 'https:tikeet.io', image: 'tikeet.png' }
];
